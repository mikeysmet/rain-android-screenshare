package com.pathfinder.rain.screenshare.data.httpserver
...
import com.pathfinder.rain.screenshare.data.other.randomString
import com.pathfinder.rain.screenshare.cio.CIOHeadersResearch
import com.pathfinder.rain.screenshare.cio.ClientAddressWorkAround
import io.ktor.http.*
...
internal fun Application.appModule(
    ...
    install(StatusPages) {
        ...
        exception<Throwable> { call, cause ->
            ...
            val headers = com.pathfinder.rain.screenshare.cio.CIOHeadersResearch.getHeadersAsString(call.request.headers as CIOHeaders)
        ...
        route(HttpServerFiles.ROOT_ADDRESS) {
            ...
            handle {
                if (clientData.enablePin.not()) {
                    ...
                    val ipAddress: InetSocketAddress? = com.pathfinder.rain.screenshare.cio.ClientAddressWorkAround.getInetSocketAddress(call.request)
