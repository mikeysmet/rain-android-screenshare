package com.pathfinder.rain.screenshare.service.helper
...
import com.pathfinder.rain.screenshare.MainActivity
import com.pathfinder.rain.screenshare.R
...
class NotificationHelper(context: Context) {
    companion object {
        private const val CHANNEL_STREAM = "com.pathfinder.rain.screenshare.service.NOTIFICATION_CHANNEL_START_STOP"
        private const val CHANNEL_ERROR = "com.pathfinder.rain.screenshare.service.NOTIFICATION_CHANNEL_ERROR"
    }
    ...
    fun createNotificationChannel() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            notificationManager.deleteNotificationChannel("com.pathfinder.rain.screenshare.service.NOTIFICATION_CHANNEL_01")
    ...
    fun showErrorNotification(appError: AppError) {
        ...
        val builder = NotificationCompat.Builder(applicationContext, CHANNEL_ERROR)
            ...
            .setLargeIcon(AppCompatResources.getDrawable(applicationContext, R.drawable.ic_launcher_background)?.toBitmap())
            .setSmallIcon(R.drawable.ic_launcher_background)
            .setContentTitle(applicationContext.getString(R.string.error_title))
            .setContentText(message)
            .setStyle(NotificationCompat.BigTextStyle().bigText(message))
            .setColor(ContextCompat.getColor(applicationContext, R.color.redish))
            .setContentIntent(
                PendingIntent.getActivity(
                    applicationContext, 0, MainActivity.getStartIntent(applicationContext), flagImmutable
                )
            )
