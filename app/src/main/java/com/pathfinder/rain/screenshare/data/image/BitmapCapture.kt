package com.pathfinder.rain.screenshare.data.image
...
import com.pathfinder.rain.screenshare.data.model.FixableError
import com.pathfinder.rain.screenshare.data.other.getLog
import com.pathfinder.rain.screenshare.data.settings.Settings
import com.pathfinder.rain.screenshare.graphics.EglCore
import com.pathfinder.rain.screenshare.graphics.FullFrameRect
import com.pathfinder.rain.screenshare.graphics.OffscreenSurface
import com.pathfinder.rain.screenshare.graphics.Texture2dProgram
...
class BitmapCapture(
    ...
    private var mEglCore: com.pathfinder.rain.screenshare.graphics.EglCore? = null
    private var mProducerSide: Surface? = null
    private var mTexture: SurfaceTexture? = null
    private var mTextureId = 0
    private var mConsumerSide: com.pathfinder.rain.screenshare.graphics.OffscreenSurface? = null
    private var mScreen: com.pathfinder.rain.screenshare.graphics.FullFrameRect? = null
    ...
    private fun startDisplayCapture() {
        ...
        if (fallback.not()) {
            ...
            try {
                mEglCore = com.pathfinder.rain.screenshare.graphics.EglCore(
                    null,
                    EglCore.FLAG_TRY_GLES3 or EglCore.FLAG_RECORDABLE
                )
                mConsumerSide = com.pathfinder.rain.screenshare.graphics.OffscreenSurface(
                    mEglCore,
                    screenSizeX,
                    screenSizeY
                )
                ...
                mScreen = com.pathfinder.rain.screenshare.graphics.FullFrameRect(
                    com.pathfinder.rain.screenshare.graphics.Texture2dProgram(Texture2dProgram.ProgramType.TEXTURE_EXT)
                )
